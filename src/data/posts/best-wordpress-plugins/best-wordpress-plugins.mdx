...
import TOC from "../../../components/Templates/PostTemplate/TOC.js";
import SubscriptionForm from "../../../components/Forms/SubscriptionForm/SubscriptionForm.js";
...
<section id="toc" className="bg-dark text-white">
  <TOC items={props.items} />
</section>
